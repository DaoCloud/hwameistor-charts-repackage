...
[![Release Chart](https://github.com/DaoCloud/hwameistor-charts-repackage/actions/workflows/release-chart.yml/badge.svg)](https://github.com/DaoCloud/hwameistor-charts-repackage/actions/workflows/release-chart.yml)
...
你可使用 本工程的 chart repo 来测试
    ...
    helm repo add daocloud https://daocloud.github.io/hwameistor-charts-repackage/
